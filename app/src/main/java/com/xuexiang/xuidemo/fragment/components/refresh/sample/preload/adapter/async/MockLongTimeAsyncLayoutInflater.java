 ...
 */
public final class MockLongTimeAsyncLayoutInflater {
    ...
    public MockLongTimeAsyncLayoutInflater(@NonNull Context context) {
    ...
    private static class InflateRequest {
        MockLongTimeAsyncLayoutInflater inflater;
        ViewGroup parent;
        int resid;
        View view;
